...
@Pipeline
def site-24-7_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="site-24-7 example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"site-24-7_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="site-24-7_field_mapping",
