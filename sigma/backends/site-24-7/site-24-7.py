...
from sigma.pipelines.site-24-7 import # TODO: add pipeline imports or delete this line
import sigma
import re
from typing import ClassVar, Dict, Tuple, Pattern, List, Any, Optional

class site-24-7-Backend(TextQueryBackend):
    """site-24-7 backend."""
    ...
    name : ClassVar[str] = "site-24-7 backend"
